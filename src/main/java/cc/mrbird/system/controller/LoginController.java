...
//        String passwordMD = MD5Utils.encrypt(username.toLowerCase(), password);
        String passwordMD = MD5Utils.md5Encode(password);
        UsernamePasswordToken token = new UsernamePasswordToken(username, passwordMD, rememberMe);
        try {
